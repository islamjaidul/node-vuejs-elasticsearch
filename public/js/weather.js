...
var _bindEvents = __webpack_require__(7);

var _bindEvents2 = _interopRequireDefault(_bindEvents);

var _bindProps = __webpack_require__(4);

var _mapElementMixin = __webpack_require__(16);
...
var _WatchPrimitiveProperties = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_google_maps__ = __webpack_require__(74);
...
"use strict";
var TestApp = __webpack_require__(69);
...
Component.options.__file = "views/assets/js/weather/WeatherApp.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-edce8f9e", Component.options)
  } else {
    hotAPI.reload("data-v-edce8f9e", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Repository_CommonRepository__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Repository_WeatherRepository__ = __webpack_require__(72);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: {
		commonRepo: function commonRepo() {
			return new __WEBPACK_IMPORTED_MODULE_0__Repository_CommonRepository__["a" /* default */]();
		}
	},
	methods: {
		setPlace: function setPlace(place) {
			...
			var URL = 'http://localhost:3000/weather-data/' + lat + '/' + lng;

			this.preload = true;
			axios.get(URL).then(function (response) {
				_this.temperature = _this.commonRepo.getCelciusValue(response.data.temperature);
				_this.apparentTemperature = _this.commonRepo.getCelciusValue(response.data.apparentTemperature);
				_this.preload = false;
			}).catch(function (err) {
...
var CommonRepository = function () {
	function CommonRepository() {
		_classCallCheck(this, CommonRepository);
	}

	_createClass(CommonRepository, [{
		key: "getCelciusValue",
		value: function getCelciusValue(fValue) {
...
/* harmony default export */ __webpack_exports__["a"] = (CommonRepository);
...
var WeatherRepository = function WeatherRepository() {
	_classCallCheck(this, WeatherRepository);
};

/* unused harmony default export */ var _unused_webpack_default_export = (WeatherRepository);
    ...
    [
      ...
      _c("h2", [
        ...
        _vm.preload
          ...
          : _c("span", [_vm._v(_vm._s(_vm.temperature) + " ℃")])
      ]),
      _vm._v(" "),
      _c("h2", [
        _vm._v("Feel Like: \n\t\t"),
        _vm.preload
          ? _c("span", [_vm._v("Loading...")])
          : _c("span", [_vm._v(_vm._s(_vm.apparentTemperature) + " ℃")])
      ])
    ],
    1
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-edce8f9e", module.exports)
  }
}
...
var _marker = __webpack_require__(75);

var _marker2 = _interopRequireDefault(_marker);

var _polyline = __webpack_require__(76);
...
var _infoWindow = __webpack_require__(80);
...
var _streetViewPanorama = __webpack_require__(91);
...
var _mountableMixin = __webpack_require__(9);
